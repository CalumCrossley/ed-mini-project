\todo{Orlov reconstruction, HKR isomorphism}
...
\begin{proof}
    ...
    We use the notation $\O(-1)\boxtimes\Omega(1)=q^*\O(-1)\otimes p^*\Omega(1)$. We have from HAR \todo{add Hartshorne reference?} the Euler sequence
    \begin{equation*}

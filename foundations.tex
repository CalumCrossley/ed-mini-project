...
The proof is slightly technical and can be found in \cite[\S7][Proposition~7.1]{Huybrechts}
...
$$\calD(Y)=\langle \ker f_*\lHom(\calE,-), \calE\otimes f^*\calD(X)\rangle$$
\end{example}
...
\begin{proof}
    ...
    \todo{define spanning classes}

    \todo{sort out this proof}
